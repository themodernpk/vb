...
export const checkAuth = (dispatch) => {
    return (dispatch) => {
        AsyncStorage.getItem('key',(err,result) => {
            if(result){
                AsyncStorage.getItem('company_slug',(errr,res) => {
                    if(errr){
                        console.log("errors are ",errr);
                    }
                    if(res){
                        AsyncStorage.getItem('company_name',(errrr,re) => {
                            let object = {name : '',slug : ''};
                            object.name=re;
                            object.slug=res;
                            dispatch({
