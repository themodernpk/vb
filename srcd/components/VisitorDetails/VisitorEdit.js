...
class VisitorEdit extends Component{
    ...
    onButtonPress() {
        ...
        this.props.SaveVisitor({ slug,name,mobile,anniversary,mail_id : email,dob,created_at, id : this.props.visitor.id });
    };
    renderButton() {
...
function mapStateToProps(state){
    const { name,mobile,email,anniversary,dob,created_at,loading,error } = state.coustomer;
